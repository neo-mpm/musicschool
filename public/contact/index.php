...
<header class="header">
  ...
  <section class="contact__hero contact-hero hero">
    <div class="contact-hero__inner hero__inner">
...
<main class="<?= $class_name; ?>">
  <div class="contact__container">
    ...
    <form class="contact__form contact-form" action="contact.php" method="post">
      ...
      <button type="submit" class="contact-form__button button">送信</button>
    </form>
  </div>
</main>
<?php
